...
class TestJobData:
    ...
    def test_job_active_status_check(self):
        ...
        for status in [JobStatus.PENDING, JobStatus.COMPLETED, JobStatus.FAILED, JobStatus.CANCELLED]:
            job.status = status
    ...
    def test_job_pending_status_check(self):
        ...
        for status in [JobStatus.RUNNING, JobStatus.COMPLETED, JobStatus.FAILED, JobStatus.CANCELLED]:
            job.status = status
    ...
    def test_job_duration_calculation(self):
        ...
        job.completed_at = start_time.replace(microsecond=start_time.microsecond + 100000)
