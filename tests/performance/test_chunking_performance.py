...
class TestChunkingPerformance:
    ...
    def test_section_detection_speed(self):
        ...
        Background: """ + " ".join([f"Background sentence {i}." for i in range(50)]) + """
        Methods: """ + " ".join([f"Methods sentence {i}." for i in range(50)]) + """
        Results: """ + " ".join([f"Results sentence {i}." for i in range(100)]) + """
        Conclusions: """ + " ".join([f"Conclusions sentence {i}." for i in range(30)])
    ...
    def test_sentence_splitting_speed(self):
        ...
        large_text = ". ".join([f"This is sentence {i} with some biomedical content" for i in range(500)]) + "."
        ...
        assert splitting_time < 0.6  # Under 600ms (slightly relaxed for spaCy model loading)
