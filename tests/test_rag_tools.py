...
class TestAbstractChunker:
    ...
    def test_chunk_structured_abstract(self):
        ...
        for chunk in chunks:
            ...
            assert chunk.section in ["Background", "Methods", "Results", "Conclusions", "Unstructured"]
...
class TestRAGTools:
    ...
    async def test_rag_tools_manager_search_no_weaviate(self):
        ...
        with patch.object(manager.weaviate, 'initialize', side_effect=Exception("Connection failed")):
