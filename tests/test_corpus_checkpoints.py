...
class TestCorpusCheckpointManager:
    ...
    async def test_checkpoint_manager_create_success(self):
        ...
        with patch('src.bio_mcp.services.services.CorpusCheckpointService') as mock_service_class:
...
class TestCorpusCheckpointMCPTools:
    ...
    async def test_checkpoint_create_tool_success(self):
        ...
        with patch('src.bio_mcp.mcp.corpus_tools.get_checkpoint_manager') as mock_get_manager:
        ...
        with patch('src.bio_mcp.mcp.corpus_tools.get_checkpoint_manager') as mock_get_manager:
            ...
            mock_result = CheckpointResult(
                ...
                checkpoint_data={
                    ...
                    "primary_queries": ["neuroscience", "brain research", "neural networks"]
                }
            )
