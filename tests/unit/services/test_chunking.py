...
class TestSentenceSplitter:
    ...
    def test_biomedical_patterns(self):
        ...
        assert len(sentences) == 2
        assert "vs. placebo" in sentences[0] or "vs placebo" in sentences[0]  # Handle both protected and unprotected
        assert "p=0.001" in sentences[0] or "p = 0.001" in sentences[0]  # Handle spacing
