...
from bio_mcp.orchestrator.synthesis.quality_scorer import QualityMetrics, QualityScorer
...
def test_completeness_scoring():
    ...
    assert (
        completeness == 0.6
    )  # Base source coverage score (3/3 sources present but no results)
...
def test_recency_scoring():
    ...
    recent_citations = [
        Citation(
            id="1", source="pubmed", title="Study 1", authors=[], year=current_year
        ),
        Citation(
            id="2", source="pubmed", title="Study 2", authors=[], year=current_year - 1
        ),
    ]
    ...
    mixed_citations = [
        ...
        Citation(
            id="2", source="pubmed", title="Study 2", authors=[], year=current_year - 10
        ),
    ]
...
def test_diversity_scoring():
    ...
    single_citations = [Citation(id="1", source="pubmed", title="Study", authors=[])]
...
def test_relevance_scoring():
    ...
    high_rel_citations = [
        Citation(
            id="1", source="pubmed", title="Study", authors=[], relevance_score=0.9
        ),
        Citation(
            id="2", source="pubmed", title="Study", authors=[], relevance_score=0.8
        ),
    ]
...
def test_count_recent_results():
    ...
    citations = [
        ...
        Citation(
            id="2", source="pubmed", title="Study", authors=[], year=current_year - 1
        ),
        Citation(
            id="3", source="pubmed", title="Study", authors=[], year=current_year - 5
        ),
...
def test_has_systematic_reviews():
    ...
    with_reviews = [
        Citation(
            id="1", source="pubmed", title="Systematic review of treatments", authors=[]
        ),
...
def test_detect_conflicts():
    ...
    old_citations = [
        Citation(
            id="1", source="pubmed", title="Study", authors=[], year=current_year - 15
        ),
        Citation(
            id="2", source="pubmed", title="Study", authors=[], year=current_year - 12
        ),
    ]
