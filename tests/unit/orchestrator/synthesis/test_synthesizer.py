...
from bio_mcp.orchestrator.synthesis.synthesizer import AdvancedSynthesizer, AnswerType, SynthesisMetrics, Citation
...
async def test_comprehensive_synthesis():
    ...
    state = OrchestratorState(
        ...
        pubmed_results={
            "results": [
                {"pmid": "123", "title": "Diabetes Study", "authors": ["Smith J"], "journal": "Nature"}
            ]
        },
        ctgov_results={
            "results": [
