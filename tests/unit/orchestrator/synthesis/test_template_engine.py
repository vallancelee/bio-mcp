...
async def test_render_partial_template():
    ...
    context = {
        ...
        "results": {
            "pubmed": {
                "results": [{"pmid": "789", "title": "Rare disease study"}]
            }
        },
        "citations": []
    }
...
async def test_render_minimal_template():
    ...
    context = {
        ...
        "results": {
            "pubmed": {
                "results": [{"pmid": "999", "title": "Single study"}]
            }
        }
    }
...
def test_format_trial_result():
    ...
    assert "ClinicalTrials.gov: [NCT456789](https://clinicaltrials.gov/ct2/show/NCT456789)" in formatted
...
def test_render_key_findings():
    ...
    context = {
        "results": {
            ...
            "clinicaltrials": {
                "results": [{"nct_id": "NCT1"}, {"nct_id": "NCT2"}]
            }
        }
    }
...
def test_render_citations():
    ...
    assert "1. Smith, J., Doe, A., Johnson, B.. Important Study. *Nature*. 2023. PMID: [123456](https://pubmed.ncbi.nlm.nih.gov/123456)" in citations
    assert "2. Brown, C.. Clinical Trial Results. 2024. ClinicalTrials.gov: [NCT789](https://clinicaltrials.gov/ct2/show/NCT789)" in citations
