...
class TestTokenBucketRateLimiter:
    ...
    async def test_acquire_more_than_capacity(self):
        ...
        with pytest.raises(ValueError, match="Cannot acquire more tokens than bucket capacity"):
    ...
    async def test_refill_tokens(self):
        ...
        limiter = TokenBucketRateLimiter(capacity=10, refill_rate=20.0)  # 20 tokens per second
