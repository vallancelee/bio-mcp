...
class TestBudgetTracker:
    ...
    def test_consume_time_within_budget(self):
        ...
        tracker = BudgetTracker(time_budget_ms=5000, token_budget=1000, request_budget=50)
    ...
    def test_consume_time_exceeds_budget(self):
        ...
        tracker = BudgetTracker(time_budget_ms=2000, token_budget=1000, request_budget=50)
    ...
    def test_consume_tokens_exceeds_budget(self):
        ...
        tracker = BudgetTracker(time_budget_ms=5000, token_budget=500, request_budget=50)
    ...
    def test_consume_requests_within_budget(self):
        ...
        tracker = BudgetTracker(time_budget_ms=5000, token_budget=1000, request_budget=10)
    ...
    def test_consume_requests_exceeds_budget(self):
        ...
        tracker = BudgetTracker(time_budget_ms=5000, token_budget=1000, request_budget=5)
...
class TestBudgetManager:
    ...
    async def test_enforce_budget_within_limits(self):
        ...
        config = OrchestratorConfig()
        manager = BudgetManager(config)
        tracker = await manager.create_tracker(time_budget_ms=5000, token_budget=1000, request_budget=50)
    ...
    async def test_enforce_budget_exceeds_limits(self):
        ...
        config = OrchestratorConfig()
        manager = BudgetManager(config)
        tracker = await manager.create_tracker(time_budget_ms=2000, token_budget=1000, request_budget=50)
    ...
    async def test_check_budget_status_warning(self):
        ...
        config = OrchestratorConfig()
        manager = BudgetManager(config)
        tracker = await manager.create_tracker(time_budget_ms=1000, token_budget=1000, request_budget=50)
    ...
    async def test_estimate_operation_cost(self):
        ...
        pubmed_cost = await manager.estimate_operation_cost("pubmed.search", {"limit": 20})
        trials_cost = await manager.estimate_operation_cost("clinicaltrials.search", {"limit": 20})
        rag_cost = await manager.estimate_operation_cost("rag.search", {"query": "diabetes", "limit": 20})
    ...
    async def test_can_afford_operation(self):
        ...
        config = OrchestratorConfig()
        manager = BudgetManager(config)
        tracker = await manager.create_tracker(time_budget_ms=3000, token_budget=1000, request_budget=5)
        
        # Should be able to afford small operation
        can_afford_small = await manager.can_afford_operation(tracker, "pubmed.search", {"limit": 10})
        ...
        can_afford_expensive = await manager.can_afford_operation(tracker, "rag.search", {"query": "test", "limit": 50})
    ...
    async def test_budget_aware_timeout(self):
        ...
        await manager.enforce_budget(tracker, ResourceType.TIME, 2000)  # This should exceed
