...
class TestBioMCPCheckpointSaver:
    ...
    async def test_init_with_memory_db(self):
        ...
        cursor.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='orchestration_checkpoints'")
        assert cursor.fetchone() is not None
        
        cursor.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='query_metrics'")
        assert cursor.fetchone() is not None
    ...
    async def test_save_orchestration_checkpoint(self):
        ...
        cursor = saver.conn.cursor()
        cursor.execute("SELECT * FROM orchestration_checkpoints WHERE checkpoint_id = ?", 
    ...
    async def test_get_orchestration_checkpoint(self):
        ...
        assert retrieved.execution_path == ["frame", "enhanced_pubmed", "enhanced_trials"]
    ...
    async def test_save_query_metrics(self):
        ...
        cursor = saver.conn.cursor()
        cursor.execute("SELECT * FROM query_metrics WHERE checkpoint_id = ?", ("test_checkpoint",))
        row = cursor.fetchone()
