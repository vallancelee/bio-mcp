...
class TestJournalQualityScorer:
    ...
    def test_calculate_quality_boost_minimal(self):
        ...
        doc = {"title": "Basic Research Study"}
    ...
    def test_apply_quality_boost(self):
        ...
        nature_result = next(
            r for r in boosted_results if "Nature" in r.get("journal", "")
        )
    ...
    def test_apply_quality_boost_zero_scores(self):
        ...
        results = [
            {"score": 0.0, "title": "Zero Score Study", "journal": "Nature"},
            {"score": None, "title": "None Score Study", "journal": "Science"},
        ]
