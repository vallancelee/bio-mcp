...
class TestPubMedDocument:
    ...
    def test_default_initialization(self):
        ...
        doc = PubMedDocument(id="", source_id="", source="", title="Test Title")
    ...
    def test_pmid_initialization(self):
        ...
        doc = PubMedDocument(
            id="", source_id="", source="", title="Test Title", pmid="12345"
        )
    ...
    def test_get_search_content_with_abstract(self):
        ...
        content = doc.get_search_content()
        assert (
            content == "Biomarker Discovery This study investigates novel biomarkers."
        )
    ...
    def test_comprehensive_document_creation(self):
        ...
        assert (
            doc.abstract
            == "This phase II trial demonstrates efficacy of modified CAR-T cells."
        )
