...
class TestConditionScoring:
    ...
    def test_cancer_condition_boost(self):
        ...
        trial = create_test_trial(
            nct_id="NCT12345678", conditions=["Lung Cancer", "NSCLC"]
        )
    ...
    def test_diabetes_condition_boost(self):
        ...
        config = ClinicalTrialQualityConfig()
        trial = create_test_trial(
            nct_id="NCT12345678", conditions=["Type 2 Diabetes Mellitus"]
        )
    ...
    def test_rare_disease_condition_boost(self):
        ...
        config = ClinicalTrialQualityConfig()
        trial = create_test_trial(
            nct_id="NCT12345678", conditions=["Rare Genetic Disorder"]
        )
    ...
    def test_common_condition_no_boost(self):
        ...
        config = ClinicalTrialQualityConfig()
        trial = create_test_trial(
            nct_id="NCT12345678", conditions=["Common Cold", "Seasonal Allergies"]
        )
...
class TestInterventionScoring:
    ...
    def test_monoclonal_antibody_boost(self):
        ...
        config = ClinicalTrialQualityConfig()
        trial = create_test_trial(
            nct_id="NCT12345678", interventions=["Anti-PD1 Monoclonal Antibody"]
        )
    ...
    def test_gene_therapy_boost(self):
        ...
        config = ClinicalTrialQualityConfig()
        trial = create_test_trial(
            nct_id="NCT12345678", interventions=["CAR-T Cell Gene Therapy"]
        )
    ...
    def test_drug_intervention_boost(self):
        ...
        config = ClinicalTrialQualityConfig()
        trial = create_test_trial(
            nct_id="NCT12345678", interventions=["Experimental Drug XYZ"]
        )
