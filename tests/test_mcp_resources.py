...
class TestBioMCPResourceManager:
    ...
    async def test_list_resources_success(self):
        ...
        assert len(result.data) == 4  # corpus/status, corpus/checkpoints, sync/recent, system/health
    ...
    async def test_get_corpus_checkpoints_success(self):
        ...
        with patch('src.bio_mcp.services.services.CorpusCheckpointService') as mock_checkpoint_service_class:
            mock_checkpoint_service = AsyncMock()
    ...
    async def test_get_system_health_success(self):
        ...
        with patch('src.bio_mcp.services.services.DocumentService') as mock_doc_service_class, \
             patch('src.bio_mcp.services.services.CorpusCheckpointService') as mock_checkpoint_service_class:
...
class TestMCPResourceEndpoints:
    ...
    async def test_list_resources_endpoint_success(self):
        ...
        with patch('src.bio_mcp.mcp.resources.get_resource_manager') as mock_get_manager:
...
class TestResourceErrorHandling:
    ...
    async def test_resource_manager_service_initialization_error(self):
        ...
        mock_doc_service = AsyncMock()
        mock_checkpoint_service = AsyncMock()
        mock_doc_service.initialize.side_effect = Exception("Database connection failed")
    ...
    async def test_resource_read_with_service_error(self):
        ...
        with patch('src.bio_mcp.services.services.CorpusCheckpointService') as mock_checkpoint_service_class:
            mock_checkpoint_service = AsyncMock()
            mock_checkpoint_service_class.return_value = mock_checkpoint_service
            mock_checkpoint_service.list_checkpoints.side_effect = Exception("Service error")
