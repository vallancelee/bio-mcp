...
class TestClinicalTrialsToolsOptimized:
    ...
    async def test_comprehensive_search_workflow(self, validator):
        ...
        assert "nct_ids" in response1_text.lower() or "results" in response1_text.lower()
        ...
        result3 = await handle_clinicaltrials_search({
            "limit": 1
        })
    ...
    async def test_response_format_and_robustness(self, validator):
        ...
        validation_tests = [
            ...
            (handle_clinicaltrials_search, {"limit": "invalid"}, "should handle gracefully"),
            (handle_clinicaltrials_get, {"nct_id": None}, "should error"),
            (handle_clinicaltrials_investment_search, {"min_investment_score": "invalid"}, "should handle gracefully"),
            (handle_clinicaltrials_investment_summary, {"nct_ids": "not_a_list"}, "should error"),
