        ...
        return [
            {
                ...
                "keywords": ["CRISPR", "gene editing", "immunotherapy", "cancer", "CAR-T"]
            },
            {
                "pmid": "12345002", 
                ...
                "keywords": ["machine learning", "drug discovery", "neural networks", "pharmaceutical"]
            },
            {
                "pmid": "12345003",
                ...
                "keywords": ["Alzheimer", "biomarkers", "tau protein", "amyloid", "cerebrospinal fluid"]
            },
            {
                "pmid": "12345004",
            ...
            },
            {
                ...
                "keywords": ["precision medicine", "cardiovascular", "genomics", "personalized therapy"]
            }
        ]
...
def weaviate_container():
    ...
    with DockerCompose(str(compose_file.parent), compose_file_name="docker-compose-weaviate.yml") as compose:
        ...
        print(f"✓ Weaviate with transformers started at {url} (gRPC: {weaviate_url}:{grpc_port})")
        ...
        yield {"http_url": url, "grpc_host": weaviate_url, "grpc_port": grpc_port, "secure": False}
...
class TestWeaviateClientInitialization:
    ...
    async def test_client_initialization(self, weaviate_client):
        ...
        print(f"✓ Weaviate client initialized with collection: {client.collection_name}")
...
class TestWeaviateClientSearch:
    ...
    async def test_search_no_results(self, weaviate_client):
        ...
        results = await client.search_documents(
            query="nonexistent biomedical topic zzxxyy",
            limit=5,
            search_mode="bm25"
        )
