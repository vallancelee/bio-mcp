...
class PubMedSearchNode(BaseToolNode):
    ...
    async def __call__(self, state: OrchestratorState) -> dict[str, Any]:
        ...
        try:
            ...
            logger.info("PubMed search completed", extra={
            ...
            return {
                ...
                "cache_hits": {**state["cache_hits"], "pubmed_search": False},  # Simple implementation
            ...
            logger.error("PubMed search failed", extra={
                "search_term": search_term,
                "error": str(e)
            })
            ...
            return {
                ...
                "messages": state["messages"] + [{
                    "role": "system",
                    "content": f"PubMed search failed: {e!s}"
                }]
            }
