...
class BioMCPCheckpointSaver(BaseCheckpointSaver):
    ...
    async def asave_checkpoint(
        ...
        bio_mcp_data: OrchestrationCheckpoint | None = None,
    ) -> str:
        ...
        """,
            (
                ...
                bio_mcp_data.completed_at.isoformat()
                if bio_mcp_data.completed_at
                else None,
    ...
    async def save_query_metrics(
        self, checkpoint_id: str, metrics: dict[str, Any]
    ) -> None:
...
class StateManager:
    ...
    async def update_checkpoint(
        self, checkpoint_id: str, state: dict[str, Any]
    ) -> None:
    ...
    async def finalize_checkpoint(
        self, checkpoint_id: str, final_state: dict[str, Any]
    ) -> None:
