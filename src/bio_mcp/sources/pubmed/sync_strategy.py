...
class PubMedSyncStrategy(BaseSyncStrategy):
    ...
    async def set_sync_watermark(self, query_key: str, timestamp: datetime) -> None:
        ...
        await self.checkpoint_manager.set_watermark(self.source_name, query_key, timestamp)
    
    async def sync_incremental(self, query: str, query_key: str, limit: int) -> dict[str, Any]:
