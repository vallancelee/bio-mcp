...
class TraceContext:
    ...
    def get_correlation_data(self) -> dict[str, Any]:
        ...
        """
        correlation = {"trace_id": self.trace_id, "tool": self.tool_name}
    ...
    def __exit__(self, exc_type, exc_val, exc_tb) -> None:
        ...
        if self._status == "error":
            logger.error(f"Tool execution failed: {self.tool_name}", **log_data)
        else:
            logger.info(f"Tool execution completed: {self.tool_name}", **log_data)
